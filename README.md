...
* **Создает nginx.conf из шаблона для защиты проксирования** копирует template, генерирует PROXY_SECRET_KEY в .env и nginx.conf, заполняет список разрешенных хостов из DEFAULT_API_URLS.
