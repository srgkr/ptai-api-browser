...
#    render_download_action(col=col_actions_1,action_id="source_project",button_label="Скачать исходный код ветки",file_prefix="source",api_endpoint=f"/api/store/{project_id}/branches/{branch_id}/sources", project_id=project_id, branch_id=branch_id)
